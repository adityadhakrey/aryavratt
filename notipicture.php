 ...
 $em=$_COOKIE["Email"];
 $pid=$n["PICTUREID"];
 $picture=mysqli_query($con,"select s.FIRSTNAME,s.LASTNAME,s.PIC,s.EMAIL,p.PICTURE,p.PICTURECAPTION,p.EMAIL,p.PICTUREID,p.DATE,p.TIME from picture p,signup s where s.EMAIL=p.EMAIL and p.PICTUREID='$pid'");
 $i=0;
