...
function showuserfriend(useremaill)
{
	var t=Math.random();
	var r=new XMLHttpRequest();
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("showuserfriends").innerHTML=r.responseText;
		}
	}
	r.open("post","showuserfriends.php?s="+t+"&userem="+useremaill);
	r.send();
}
function finduserfriends(useremail)
{
	var t=Math.random();
	var r=new XMLHttpRequest();
	var ff=document.getElementById("searchuserfriends").value;
	if(ff=="")
	{
		alert("please enter Friend's Name");
		document.getElementById("searchuserfriends").focus();
		document.getElementById("userfrnd").style.display="none";
	...
	r.onreadystatechange=function()
	{
		...
		{
			alert(r.responseText);
			document.getElementById("userfrnd").innerHTML=r.responseText;
			document.getElementById("showuserfriends").style.display="none";
		}
	}
	r.open("post","finduserfriends.php?s="+t+"&text="+ff+"&userem="+useremail);
	r.send();
	}
}
/*==trending projeccts==*/
...
<body style="background:url('wallpapers/w3.jpg');" onload="showuserfriend('<?php echo $userem; ?>');tp()">
...
<div class="agileits-w3layouts-footer">
			...
			<div class="col-sm-6">
			<input type="text"  style="width:80%;" id="searchuserfriends"  placeholder="Search For A Friend....." class="input-field">
<button type="submit"  onclick="finduserfriends('<?php echo $userem;?>')" class="btnsignup"><i class="fa fa-search"></i></button>
			</div>
			<div class="col-sm-3">
			</div>
			</div>
