...
<?php
 ...
 $em=$_COOKIE["Email"];
 $project=mysqli_query($con,"select s.FIRSTNAME,s.LASTNAME,s.PIC,s.EMAIL,p.PROJECT,p.DATE,p.TIME,p.TITLE,p.SUMMARY,p.CATEGORY,p.EMAIL,p.PROJECTID from project p,signup s where s.EMAIL=p.EMAIL and p.EMAIL='$em' order by p.PROJECTID desc");
$i=0;
