		...
		if($em==$showvc["COMMENTBY"])
		{
		 ...
		 <?php
		  ...
		  else
		  {
			  ...
			  ?>
		  <h6 style="color:white;" class="w3-text-teal"><a onclick="deletevideocomment('<?php echo $i; ?>','<?php echo $showvc["COMMENTID"];?>')" onmouseover="this.style.color='orange'" onmouseout="this.style.color='white'" style="cursor:pointer;color:white;"><i class="fa fa-trash fa-fw"></i>Delete</a></h6>
 <?php
		  }
		  }
		  ?>
