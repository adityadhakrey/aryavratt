...
$f=mysqli_query($con,"select s.FIRSTNAME,s.LASTNAME,s.EMAIL,s.GENDER,s.PIC,s.AGE,s.CITY,s.COUNTRY,f.FRIENDEMAIL,f.EMAIL,f.FRIENDID from friend f,signup s where s.EMAIL=f.FRIENDEMAIL and f.EMAIL='$userem' order by f.FRIENDID desc");
$i=0;
