...
$em=$_COOKIE["Email"];
$vid=$n["VIDEOID"];
$video=mysqli_query($con,"select s.FIRSTNAME,s.LASTNAME,s.PIC,s.EMAIL,v.VIDEOID,v.VIDEO,v.VIDEOCAPTION,v.EMAIL,v.DATE,v.TIME from video v,signup s where s.EMAIL=v.EMAIL and v.VIDEOID='$vid'");
 $i=0;
