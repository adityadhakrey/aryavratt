...
function hscrr()
{
    v=document.getElementById("hscr").scrollTop;
...
function showhomedata()
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			...
			document.getElementById("showhdata").innerHTML=r.responseText;
			document.getElementById("hscr").scrollTop=v;
			
		}
	}
	r.open("get","showhomedata.php?s="+t);
	r.send();
	
}
 setInterval("showhomedata()",1000);
...
function showhomestatus()
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("showhstatus").innerHTML=r.responseText;
			
		}
	}
	r.open("get","showhomestatus.php?s="+t);
	r.send();
...
function showstatuscomment(i,sid)
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("statuscomment"+i).innerHTML=r.responseText;
		}
	}
...
function picturehshow()
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("showhpicture").innerHTML=r.responseText;
			
		}
	}
	r.open("get","showhomepicture.php?s="+t);
	r.send();
...
function videohshow()
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("showhvideo").innerHTML=r.responseText;
		}
	}
	r.open("get","showhomevideo.php?s="+t);
	r.send();
}
...
/*--ending of all function of video--*/
/*==trending projeccts==*/
...
/*==trending video show==*/
function tclosevcmnt(i)
{
document.getElementById("tvscopen"+i).style.display="none";
document.getElementById("tclvcmnt"+i).style.display="none";
document.getElementById("tvm"+i).style.display="block";
	 
}
 
function tvscmnt(i,vid)
{

document.getElementById("tvscopen"+i).style.display="block";
document.getElementById("tclvcmnt"+i).style.display="block";
document.getElementById("tvm"+i).style.display="none";

tshowvac(i,vid);

}
function tshowvac(i,vid)
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("tvsc"+i).innerHTML=r.responseText;
		//alert(r.responseText);
		}
	}
	r.open("get","tvcmnt.php?s="+t+"&i="+i+"&vid="+vid);
	r.send();
...
function tvideoedit(i)
{

	document.getElementById("tvideditor"+i).style.display="block";

}
	
function tvidedit(vid,i)
{
	var txts=document.getElementById("tve"+i).value;
	var t=Math.random();
	var r=new XMLHttpRequest();
	if(txts=="")
	{
		alert("box is empty");
		document.getElementById("tve"+i).focus();
	}
	else
	{
	r.onreadystatechange=function()
...
function tclosevidedit(i)
{
	document.getElementById("tvideditor"+i).style.display="none";
}
...
function topenvce(i)
{
	...
	document.getElementById("tvcomedit"+i).style.display="block";

}
	
function tvcomdit(cid,i)
{
	var txts=document.getElementById("tvce"+i).value;
	var t=Math.random();
	var r=new XMLHttpRequest();
	if(txts=="")
	{
		alert("box is empty");
		document.getElementById("tvce"+i).focus();
	}
	else
	{
	r.onreadystatechange=function()
...
function tclosevce(i)
{
	document.getElementById("tvcomedit"+i).style.display="none";
...
function trendingvideo()
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("trendingvideo").innerHTML=r.responseText;
		}
	}
	r.open("get","trendingvideo.php?s="+t);
	r.send();
}
function tvideolike(vid,email)
	{
		var t=Math.random();
		var r=new XMLHttpRequest();
		r.onreadystatechange=function()
		...
		r.open("get","videolike.php?s="+t+"&vid="+vid+"&email="+email);
		r.send();
	}
	
	function tvideodislike(vid)
	{
		...
		r.open("get","videodislike.php?s="+t+"&vid="+vid);
		r.send();
}
function tpostvideocomment(vid,i,email)
   {
	     var text=document.getElementById("tvideocomment"+i).value;
	     var t=Math.random();
	     var r=new XMLHttpRequest();
	     if(text=="")
	{
		document.getElementById("tvideocomment"+i).focus();
	}
	else
	{
	r.onreadystatechange=function()
...
function tshowvideocomment(i,vid)
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("tvideocomment"+i).innerHTML=r.responseText;
		}
	}
	r.open("get","tshowvideocomment.php?s="+t+"&i="+i+"&vid="+vid);
	r.send();
	
	
}
function tdeletevideocomment(i,cid)
{
	var t=Math.random();
	var r=new XMLHttpRequest();
	r.onreadystatechange=function()
...
<body style="background:url('wallpapers/w3.jpg');" onload="defaultopen();showhomedata();tp();trendingvideo()">
...
<!---upload picture modal-->
 <div class="modal fade" id="uploadpicture" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header" style="background-color:black;color:white;">
          <button type="button" class="close" style="color:white;" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="font-size:14px;color:white;"><i class="fa fa-photo"></i>Upload Picture</h4>
        </div>
        <div class="modal-body" style="background:url(images/model.jpg);">
		  <form action="myhome.php" method="post" enctype="multipart/form-data">
	<input type="file" onmouseover="this.style.color='green'" onmouseout="this.style.color='white'" style="color:white;" name="picture" required>
  	<textarea style="resize:none;width:100%;color:black;" name="picturetext"  rows="5" placeholder="Any Caption For Your Picture.." ></textarea>
 ...
 <div class="modal fade" id="uploadvideo" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header" style="background-color:black;color:white;">
          <button type="button" class="close" style="color:white;" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="font-size:14px;color:white;"><i class="fa fa-camera-retro"></i>Upload Your Videos</h4>
        </div>
        <div class="modal-body" style="background:url(images/model.jpg);">
		  <form action="myhome.php" method="post" enctype="multipart/form-data">
  	...
  	<textarea style="resize:none;width:100%;color:black;" name="videotext"  rows="5" placeholder="Any Caption For Your video.." ></textarea>
...
<div class="agileits-w3layouts-footer">
	...
	<!---area for Home Things start-->
<div class="col-sm-5">
					<div class="tab">
  <button class="tablinks" id="defaultOpen" onclick="openCity(event, 'hometab')"><i class="fa fa-heart"></i>Recent</button>
	...
	<div class="agileits-w3layouts-footer">
			...
			<div class="col-sm-12">
				<div class="col-md-12 w3-agile-grid">
					<h5><i class="fa fa-rocket"></i>Share From Here</h5>
	<textarea name="status" style="resize:none;width:100%;color:black;" id="status"  rows="5" placeholder="Whats In Your Mind..." required=""></textarea>
<button type="button" id="statuspost" onclick="statuspost()" class="btnpost" >POST</button>&nbsp <a data-toggle="modal" data-target="#uploadpicture" onmouseover="this.style.color='orange'" onmouseout="this.style.color='white'" style="color:white;cursor:pointer;"><i class="fa fa-photo"></i>Picture</a>
<a data-toggle="modal" data-target="#uploadvideo" onmouseover="this.style.color='orange'" onmouseout="this.style.color='white'" style="color:white;cursor:pointer;"><i class="fa fa-camera-retro"></i>Video</a>
					</div>
					</div>
					</div>
					<div class="row" style="color:white;">
<div class="col-sm-12">	
		  <div  id="showhdata"></div>
...
<div class="col-sm-12">
<div class="w3l-heading">
				<h3 style="font-size:16px;color:white;">Trending Videos</h3>
				<hr>
<div id="trendingvideo">asd</div>
</div>
</div>
</div>
</div>
