...
function bookmark()
{
	...
	r.onreadystatechange=function()
	{
		if(r.readyState==4)
		{
			document.getElementById("bookmark").innerHTML=r.responseText;
		}
	}
	r.open("get","mybookmark.php?s="+t);
	r.send();
}
function removebook(prid)
{
	var t=Math.random();
	var r=new XMLHttpRequest();
	r.onreadystatechange=function()
	...
	r.open("get","removebook.php?s="+t+"&prid="+prid);
	r.send();
}
</script>
<style>
...
<body style="background:url('wallpapers/w3.jpg');" onload="bookmark();">
...
<div class="row">
<div class="col-sm-2">
<img style="width:100%;height:80px;" src="user/<?php echo $noti["PIC"];?>">
</div>
<div class="col-sm-10">
<?php
...
?>
		...
		<div class="dropdown-divider"></div>
			...
			<div class="col-sm-12">
			<div class="agileits-w3layouts-footer">
<h4 style="text-align:center;color:white;"><i class="fa fa-briefcase"></i>Your Recent Activities</h4>
<hr>
<div id="bookmark"></div>
</div>
			</div>
