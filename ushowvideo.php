...
$em=$_COOKIE["Email"];
$video=mysqli_query($con,"select s.FIRSTNAME,s.LASTNAME,s.PIC,s.EMAIL,v.VIDEOID,v.VIDEO,v.VIDEOCAPTION,v.EMAIL,v.DATE,v.TIME from video v,signup s where s.EMAIL=v.EMAIL and v.EMAIL='$userem' order by v.VIDEOID desc");
 $i=0;
...
<?php
  ...
  <!--modal end-->
	...
	<h5 class="w3-opacity"><img src="user/<?php echo $showvideo["PIC"];?>" class="img img-circle" style="width:10%;height:50px;"><a href="user.php?useremail=<?php echo $showvideo["EMAIL"];?>" onmouseout="this.style.color='white'"onmouseover="this.style.color ='orange'" style="color:white;"><?php echo $showvideo["FIRSTNAME"]."&nbsp".$showvideo["LASTNAME"];?></a><a style="color:orange;">&nbspPosted A Video</a></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $showvideo["DATE"];?> - <span class="w3-tag w3-teal w3-round"><?php echo $showvideo["TIME"];?></span>&nbsp <a onclick="videoedit('<?php echo $i; ?>')" onmouseout="this.style.color='white'"onmouseover="this.style.color ='orange'" style="cursor:pointer;color:white;"><i class="fa fa-edit fa-fw"></i>Edit</a><a onclick="deletevideo('<?php echo $showvideo["VIDEOID"];?>')" onmouseout="this.style.color='white'"onmouseover="this.style.color ='orange'" style="cursor:pointer;color:white;"><i class="fa fa-trash fa-fw"></i>Delete</a></h6>
